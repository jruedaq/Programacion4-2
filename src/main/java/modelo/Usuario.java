...
public class Usuario implements java.io.Serializable {
    ...
    public String toString() {
        ...
        return "Usuario{" + "idUsuario=" + idUsuario + ", rol=" + rol.getIdRol() + ", direccion=" + direccion + ", nombre=" + nombre + ", apellido=" + apellido + ", edad=" + edad + ", especialiicion=" + especialiicion + ", cargo=" + cargo + '}';
    }
